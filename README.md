...
2. The user submits an issue through a reporting form.
3. The system analyzes the description and assigns a priority.
4. The issue is stored in the database.
5. The admin views all issues in the dashboard.
6. The admin updates the issue status based on progress.
